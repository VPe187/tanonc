        ...
        <div class="col-md-8">
            <div class="card shadow">
                ...
                <label for="formFileLg" class="form-label">Kérem válassza ki a feltölteni kívánt fájlt</label>-->
                    ...
                    <p class="btn btn-lg btn-primary shadow"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cloud-upload" viewBox="0 0 16 16">
